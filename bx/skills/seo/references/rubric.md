...
The `/bx:seo` total score is out of 100, computed from 5 dimensions with **fixed base weights** and **±5 per-dimension tuning** applied from the orchestrator's fetched best-practices brief.
