...
effort: low
allowed-tools: Read, Edit, Write, Grep, Glob, Bash(git:*), Bash(ls:*), Bash(find:*), Bash(wc:*), Bash(awk:*), Bash(sort:*), Bash(cp:*), Bash(bash:*), TaskList, TaskGet, AskUserQuestion, Agent
