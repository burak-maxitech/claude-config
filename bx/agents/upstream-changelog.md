...
- `finding_id`, `source_url` canonicalization, and `source_content_hash` normalization algorithms come from `bx/skills/evolve/references/state-schema.md` via your task prompt — do not improvise alternatives or restate them here.
