...
- Hash the verbatim heading-bounded section text, never WebFetch's summary prose — summaries are unstable across calls and re-raise rejected findings on every run (state-schema Rule 3).
