...
Cross-reference CLAUDE.md against the section contract at `../bx-docs/references/claude-md-sections.md`. If sections are missing or malformed, note this in the summary and suggest running `/bx-docs` to fix it.
