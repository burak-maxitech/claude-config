...
- **Defer to /code-cleanup** for: orphaned test files, >3mo skipped tests, unused test helpers, stale snapshots. If detected in passing, note in `recommended_action` and DO NOT emit a separate finding.
