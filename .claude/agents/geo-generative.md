---
name: geo-generative
description: Scans structured data (Schema.org JSON-LD) and Generative Engine Optimization signals — llms.txt, E-E-A-T, AI-citability patterns, AI-bot crawl access. The GEO field evolves rapidly; relies on the orchestrator's fetched best-practices brief as primary source of truth. Used by the seo-review skill. Do not invoke independently.
model: sonnet
