...
| **SEO + GEO Audit** | `/seo-review` | Repo-wide SEO + Generative Engine Optimization audit for web projects. Fetches current best practices every run. Probes sitemap URL health. **Optional GSC CSV ingestion** for traffic-aware recommendations + git-history overlap. Score `/100` tracked over time. |
